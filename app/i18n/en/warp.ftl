...
ssh-remote-choice-continue-without-installing-desc = You'll still get a Warpified experience just without the coding features.
...
inline-agent-header-waiting-on-instructions = Agent is waiting on instructions
