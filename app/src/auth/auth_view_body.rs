...
impl AuthViewBody {
    ...
    fn render_privacy_information(
        ...
        let disclaimer_line_2 = if FeatureFlag::GlobalAIAnalyticsBanner.is_enabled() {
            ...
            Flex::column()
                .with_child(
                    ui_builder
                        .paragraph(crate::t!("auth-opt-out-line-1"))
                        .with_style(disclaimer_styles)
                        .build()
                        .finish(),
                )
                .with_child(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .paragraph(crate::t!("auth-opt-out-line-2-prefix"))
                                .with_style(disclaimer_styles)
                                .build()
                                .finish(),
                        )
                        .with_child(
                            ui_builder
                                .link(
                                    crate::t!("auth-privacy-settings-title").into(),
                                    None,
                                    Some(Box::new(|ctx| {
                                        ctx.dispatch_typed_action(AuthViewBodyAction::ShowOverlay(
                                            AuthViewOverlay::PrivacySettings,
    ...
    fn render_sign_up_button(
        ...
        ui_builder
            ...
            .with_centered_text_label(crate::t!("auth-sign-up").into())
            .build()
    ...
    fn render_sign_in_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Flex::row()
            .with_child(
                ui_builder
                    .span(crate::t!("auth-already-have-account"))
                    .build()
                    .finish(),
            )
            .with_child(
    ...
    fn render_sign_up_later_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Container::new(
            Flex::row()
                .with_child(
                    ui_builder
                        .span(crate::t!("auth-dont-want-sign-in-now"))
                        .build()
                        .finish(),
                )
                .with_child(
                    ui_builder
                        .link(
                            crate::t!("auth-skip-for-now").into(),
                            None,
                            Some(Box::new(|ctx| {
    ...
    fn render_sign_in_later_confirm_row(&self, ui_builder: &UiBuilder) -> Box<dyn Element> {
        Container::new(
            Flex::column()
                .with_child(
                    ui_builder
                        .paragraph(crate::t!("auth-skip-login-confirm-title"))
                        .build()
                        .finish(),
                )
                .with_child(
                    ui_builder
                        .paragraph(crate::t!("auth-skip-login-confirm-line-1"))
                        .build()
                        .finish(),
                )
                .with_child(
                    Flex::row()
                        .with_child(
                            ui_builder
                                .span(crate::t!("auth-skip-login-confirm-line-2-prefix"))
                                .build()
                                .finish(),
                        )
                        .with_child(
                            ui_builder
                                .link(
                                    crate::t!("auth-yes-skip-login").into(),
                                    None,
                                    Some(Box::new(|ctx| {
    ...
    fn render_force_login_disclaimer(
        ...
        let text = match self.variant {
            AuthViewVariant::RequireLoginCloseable => {
                crate::t!("auth-require-login-ai-collaboration")
            }
            AuthViewVariant::HitDriveObjectLimitCloseable => {
                crate::t!("auth-require-login-drive-limit")
            }
            AuthViewVariant::ShareRequirementCloseable => crate::t!("auth-require-login-share"),
            _ => String::new(),
        };
    ...
    fn render_header(&self, appearance: &Appearance, ui_builder: &UiBuilder) -> Box<dyn Element> {
        ...
        let text = match self.variant {
            AuthViewVariant::Initial => crate::t!("auth-welcome-title"),
            AuthViewVariant::RequireLoginCloseable
            | AuthViewVariant::HitDriveObjectLimitCloseable
            | AuthViewVariant::ShareRequirementCloseable => crate::t!("auth-sign-up-for-warp"),
        };
    ...
    fn render_browser_open_content(
        ...
        let header = Container::new(
            ui_builder
                .paragraph(crate::t!("auth-browser-sign-in-title"))
                .with_style(header_styles)
                .build()
                .finish(),
        )
        ...
        let hint = Container::new(
            Flex::column()
                ...
                .with_child(
                    ui_builder
                        .span(crate::t!("auth-open-page-manually-suffix"))
                        .build()
                        .finish(),
                )
                .finish(),
