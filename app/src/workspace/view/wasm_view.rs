...
impl Workspace {
    ...
    pub(super) fn build_open_in_warp_button(
        ...
        ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(crate::t!("terminal-open-in-warp"), PrimaryTheme).on_click(move |ctx| {
    ...
    pub(super) fn build_view_cloud_runs_button(
        ...
        ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(crate::t!("workspace-view-all-cloud-runs"), SecondaryTheme).on_click(move |ctx| {
